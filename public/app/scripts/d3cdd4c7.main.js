...
(function(module) {
    ...
    module.CollectionView = Backbone.View.extend({
        ...
        initPlanBoard: function(el_content) {
            el_content.append(this.template());
...
(function(module) {
    ...
    module.ModelView = Backbone.View.extend({
        ...
        showPlan: function() {
            console.log("Tab1:press");
            Backbone.Mediator.pub('ScrumPage:PlanBoardSelected', $("#ScrumPage"));
        },

        showScrum: function() {
            console.log("Tab2:press");
